...
<meta name="description" content="tailus ui html-vite and tailwindcss 3.1 boilerplate" />
<title>neplen</title>
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
<script type="module" crossorigin src="assets/js/app.446fa6c4.js"></script>
...
<body class="min-h-screen bg-white selection:bg-primary/10 selection:text-primary dark:bg-gray-900">
                ...
                <div class="relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 lg:py-4">
                    <div class="relative z-20 flex w-full justify-between md:px-0 lg:w-max">
                        <a href="index.html" aria-label="logo" class="flex items-center space-x-2">
                            <svg class="h-7 w-auto"  viewBox="0 0 189 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path class='dark:fill-white' d="M78.04 34V13H81.88L91.75 27.79V13H95.59V34H91.75L81.88 19.24V34H78.04ZM99.6611 34V13H113.371V16.09H103.501V21.85H112.471V24.85H103.501V30.91H113.371V34H99.6611ZM117.005 34V13H124.775C126.455 13 127.845 13.28 128.945 13.84C130.045 14.4 130.865 15.17 131.405 16.15C131.945 17.13 132.215 18.23 132.215 19.45C132.215 20.61 131.955 21.68 131.435 22.66C130.915 23.62 130.105 24.4 129.005 25C127.905 25.58 126.495 25.87 124.775 25.87H120.845V34H117.005ZM120.845 22.75H124.535C125.875 22.75 126.835 22.46 127.415 21.88C128.015 21.28 128.315 20.47 128.315 19.45C128.315 18.41 128.015 17.6 127.415 17.02C126.835 16.42 125.875 16.12 124.535 16.12H120.845V22.75ZM135.228 34V13H139.068V31H148.368V34H135.228ZM151.751 34V13H165.461V16.09H155.591V21.85H164.561V24.85H155.591V30.91H165.461V34H151.751ZM169.095 34V13H172.935L182.805 27.79V13H186.645V34H182.805L172.935 19.24V34H169.095Z" fill="black"  />
                                <path d="M61.3282 2.64746C60.4378 0.990293 58.8478 0 57.0749 0H43.7903C41.9645 0 40.2658 1.06471 39.3569 2.77912L27.6968 24.8432L22.5292 15.0662C21.4957 13.1085 19.6327 11.9379 17.5472 11.9379C15.4642 11.9379 13.6013 13.1085 12.5651 15.0662L0.698316 37.5167C-0.239792 39.2912 -0.231842 41.4092 0.716866 43.1751C1.66557 44.9439 3.36159 46 5.25371 46H18.1302C19.9216 46 21.5858 44.9553 22.4736 43.2753L27.6968 33.3952L32.6178 42.7028C33.6911 44.7378 35.7051 46 37.8702 46H37.8993C39.9584 46 41.8717 44.7979 42.892 42.866L61.3441 7.95097C62.2239 6.28808 62.2186 4.30463 61.3282 2.64746ZM57.7692 6.16787L39.2933 41.1258C39.0468 41.5923 38.583 41.8871 38.0822 41.8871H37.5204C37.0169 41.8871 36.5478 41.5923 36.2987 41.1201L29.9572 29.1192L43.1702 4.11573H56.6668C57.1226 4.11573 57.5334 4.37046 57.7639 4.79978C57.9945 5.22623 57.9971 5.73855 57.7692 6.16787ZM25.4363 29.1192L18.6893 41.8843H5.56641C5.01255 41.8843 4.5117 41.5723 4.23345 41.0543C3.95254 40.5362 3.95254 39.9123 4.22815 39.3914L16.1003 16.9237C16.4024 16.357 16.943 16.0164 17.5472 16.0164C18.1514 16.0164 18.692 16.357 18.9941 16.9237L25.4363 29.1192Z" fill="#2B00D4" />
                            </svg>
                        </a>
                    ...
                    <div id="navlinks" class="invisible absolute top-full left-0 z-20 w-full origin-top-right translate-y-1 scale-90 flex-col flex-wrap justify-end gap-6 rounded-3xl border border-gray-100 bg-white p-8 opacity-0 shadow-2xl shadow-gray-600/10 transition-all duration-300 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none lg:visible lg:relative lg:flex lg:w-auto lg:translate-y-0 lg:scale-100 lg:flex-row lg:items-center lg:gap-0 lg:border-none lg:bg-transparent lg:p-0 lg:opacity-100 lg:shadow-none lg:peer-checked:translate-y-0 dark:lg:bg-transparent">
                        <div class="text-gray-600 dark:text-gray-300 lg:pr-4">
                            <ul class="space-y-6 text-base font-medium tracking-wide lg:flex lg:space-y-0 lg:text-sm">
                                <li>
                                    <a href="#solution" class="block transition hover:text-primary dark:hover:text-primaryLight md:px-4">
                                        <span>Solution</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="pages/" class="block transition hover:text-primary dark:hover:text-primaryLight md:px-4">
                                        <span>Customers</span>
                                    </a>
                                </li>
                                <li>
                        ...
                        <div class="mt-12 -ml-1 flex w-full flex-col space-y-2 border-primary/10 dark:border-gray-700 sm:flex-row md:w-max lg:mt-0 lg:mr-6 lg:space-y-0 lg:border-l lg:pl-6">
                            <a href="pages/login.php" class="relative ml-auto flex h-9 w-full items-center justify-center before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-primaryLight sm:px-4 lg:before:border lg:before:border-gray-200 lg:before:bg-gray-100 lg:dark:before:bg-gray-800">
                                <span class="relative text-sm font-semibold text-white dark:text-gray-900 lg:text-primary lg:dark:text-white">Login</span>
                            </a>
                        </div>
                        <button id="light" aria-label="switch theme" class="switcher group relative hidden h-9 w-9 rounded-full before:absolute before:inset-0 before:rounded-full before:border before:border-gray-200 before:bg-gray-50 before:bg-gradient-to-b before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-gray-800 lg:flex">
                            <svg xmlns="http://www.w3.org/2000/svg" id="sun" class="transistion relative m-auto hidden h-5 w-5 fill-gray-500 duration-300 group-hover:rotate-180 group-hover:fill-yellow-400 dark:block dark:fill-gray-300" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clip-rule="evenodd"></path>
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" id="moon" class="transistion relative m-auto h-5 w-5 fill-gray-500 duration-300 group-hover:-rotate-90 group-hover:fill-blue-900 dark:hidden" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                            </svg>
                        </button>
                    </div>
                    <div class="fixed top-3 right-14 z-20 sm:right-24 lg:hidden">
                        <button id="dark" aria-label="switche theme" class="switcher group relative flex h-9 w-9 rounded-full before:absolute before:inset-0 before:rounded-full before:border before:border-gray-200 before:bg-gray-50 before:bg-gradient-to-b before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-gray-800">
    ...
    <section class="pt-32 sm:pt-40 md:pt-48">
        <div class="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
            <div class="relative">
                <h1 class="text-center text-5xl font-bold text-blue-900 dark:text-white sm:text-6xl lg:text-left lg:text-7xl">
                    ...
                    <span class="relative">
                        ...
                        <span class="relative bg-gradient-to-r from-primary to-secondaryLight bg-clip-text text-transparent dark:from-primaryLight dark:to-secondaryLight md:px-2">Share</span>
                    </span>
                </h1>

                <div class="relative items-center gap-12 lg:flex mt">
                    <div class="text-center sm:mx-auto sm:w-11/12 md:mt-12 md:w-4/5 lg:mt-0 lg:mr-auto lg:w-6/12 lg:text-left">
                        <p class="mt-12 text-lg text-gray-600 dark:text-gray-300 sm:text-xl">Neplen provides a nfc based business cards. <br>
                             Now you can share your personal or business <br> details with just a single tap. </p>
                        <!-- <form  method="post" class="mt-12"> -->
                            <div class="mt-12 relative flex items-center rounded-full border border-primary/20 bg-white p-1 px-2 shadow-md focus-within:ring-2 dark:border-white/10 dark:bg-dark dark:text-white md:p-2 lg:pr-3">
                                ...
                                <input aria-label="your username" autocomplete="" placeholder="Your Username" class="w-full rounded-full bg-transparent p-4  outline-none dark:placeholder-white" type="text" id="username" />
                                <div class="md:pr-1.5 lg:pr-0">
                                    <button type="submit" id="check-name-btn" title="Start buying" class="relative ml-auto h-12 w-16 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 active:duration-75 active:before:scale-95 dark:before:bg-primaryLight sm:w-auto sm:px-6">
                                        <span class="relative hidden w-max font-semibold text-white dark:text-gray-900 md:block"> Check Name </span>
                        ...
                        <div class="mt-12 hidden lg:block">
                            <span class="text-gray-700 dark:text-white">From the most talented <a href=".html" class="text-primary underline dark:text-primaryLight">Team</a> !</span>
                            <div class="mt-5 flex -space-x-1 children:h-10 children:w-10 children:rounded-full children:object-cover children:ring-4 children:ring-gray-100 dark:children:ring-gray-900">
                                <img src="images/avatars/avatar.webp" alt="user avatar" width="400" height="400" />
                                <img src="images/avatars/avatar-1.webp" alt="user avatar" width="200" height="200" />
                                <img src="images/avatars/avatar-2.webp" alt="user avatar" width="200" height="200" />
                                <img src="images/avatars/avatar-3.webp" alt="user avatar" width="200" height="200" />
                                <img src="images/avatars/avatar-4.webp" alt="user avatar" width="200" height="200" />
                            </div>
                        </div>
                    </div>
                    <div class="mt-12 w-full overflow-hidden sm:mt-20 lg:-mt-8 lg:w-6/12">
                        <img class="w-full" src="images/hero/FOR_HOMEPAGE-removebg-preview.png" class="w-full" alt="team illustration" height="600" width="800" />
                    </div>
                </div>
            ...
            <div class="mx-auto px-4  sm:px-12   xl:max-w-6xl xl:px-0">
                <div class="relative -mx-4 mt-16 flex snap-x snap-mandatory justify-between gap-6 overflow-x-auto border-y border-gray-100 px-4 py-8 dark:border-gray-800 sm:-mx-12 sm:px-12 lg:mx-0 lg:px-0">
                    <div class="snap-center text-center sm:text-left">
                        <div class="mx-auto mb-4 flex h-20 w-20 rounded-xl border border-primary/20 bg-white shadow-md shadow-primary/10 dark:border-gray-700 dark:bg-gray-800 sm:mr-auto sm:ml-0">

                            <img   src='assets/img/main/statistic.png' alt >
                        </div>
                        <h2 class="mx-auto w-max text-lg font-semibold text-gray-700 dark:text-white sm:ml-0 sm:w-auto"> Unlimited links</h2>
                    </div>
                    <div class="snap-center text-center sm:text-left">
                        <div class="mx-auto mb-4 flex h-20 w-20 rounded-xl border border-purple-500/20 bg-white shadow-md shadow-purple-600/10 dark:border-gray-700 dark:bg-gray-800 sm:mr-auto sm:ml-0">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="m-auto h-12 w-12 text-purple-600">
                        ...
                        <h2 class="mx-auto w-max text-lg font-semibold text-gray-700 dark:text-white sm:ml-0 sm:w-auto">Affordable Advertisement</h2>
                    </div>
                    <div class="snap-center text-center sm:text-left">
                        <div class="mx-auto mb-4 flex h-20 w-20 rounded-xl border bg-white shadow-md shadow-yellow-600/10 dark:border-gray-700 dark:bg-gray-800 sm:mr-auto sm:ml-0">
                            <img  src='assets/img/main/bucket-dynamic-premium.png'   >
                        </div>
                        <h2 class="mx-auto w-max text-lg font-semibold text-gray-700 dark:text-white sm:ml-0 sm:w-auto">Differnt themes design</h2>
        ...
        <section class="relative">
            <div class="mx-auto px-4  sm:px-12   xl:max-w-6xl xl:px-0">
                <div class="relative -mx-4 mt-16 flex snap-x snap-mandatory justify-between gap-6 overflow-x-auto border-y border-gray-100 px-4 py-8 dark:border-gray-800 sm:-mx-12 sm:px-12 lg:mx-0 lg:px-0">
                    <div class="snap-center text-center sm:text-left">
                        <div class="mx-auto mb-4 flex h-20 w-20 rounded-xl border border-primary/20 bg-white shadow-md shadow-primary/10 dark:border-gray-700 dark:bg-gray-800 sm:mr-auto sm:ml-0">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="m-auto h-12 w-12 text-primary dark:text-blue-300">
                    ...
                    <div class="snap-center text-center sm:text-left">
                        <div class="mx-auto mb-4 flex h-20 w-20 rounded-xl border border-purple-500/20 bg-white shadow-md shadow-purple-600/10 dark:border-gray-700 dark:bg-gray-800 sm:mr-auto sm:ml-0">
                           <img src='assets/img/main/market.png'  alt='market' >
                        </div>
                    ...
                    <div class="snap-center text-center sm:text-left">
                        <div class="mx-auto mb-4 flex h-20 w-20 rounded-xl border bg-white shadow-md shadow-yellow-600/10 dark:border-gray-700 dark:bg-gray-800 sm:mr-auto sm:ml-0">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="m-auto h-12 w-12 text-yellow-700">
                ...
                <!-- <div class="mt-12 border-y border-gray-100 py-8 text-center dark:border-gray-800 md:py-12 xl:mt-20">
                    <a href="customers.html" class="text-sm font-semibold tracking-wider text-gray-800 dark:text-white">TRUSTED BY YOUR FAVORED TOP TECHS COMPANIES</a>
                    <div class="mt-8 flex flex-wrap justify-center gap-6 brightness-75 contrast-200 grayscale dark:brightness-200 dark:contrast-0 sm:justify-between lg:gap-24">
                        <img class="h-8 w-auto lg:h-10 lg:w-auto" src="images/companies/inet.png" loading="lazy" alt="airbnb" width="" height="" />
                        <img class="h-8 w-auto lg:h-10 lg:w-auto" src="images/companies/rmp.png" loading="lazy" alt="bissell" width="" height="" />
                        <img class="h-8 w-auto lg:h-10 lg:w-auto" src="images/companies/ordrz.svg" loading="lazy" alt="ge" width="100" height="100" />
                        <img class="h-8 w-auto lg:h-10 lg:w-auto" src="images/companies/eximcredit.png" loading="lazy" alt="lilly" width="" height="" />
                        <img class="h-8 w-auto lg:h-10 lg:w-auto" src="images/companies/ecf.png"  alt="microsoft" width="" height="" />
                    </div>
                </div> -->
    ...
    <section class="relative" id="solution">
            <div aria-hidden="true" class="absolute inset-0 top-56 grid grid-cols-2 -space-x-52 opacity-50 dark:opacity-30">
                <div class="h-32 bg-gradient-to-br from-primary to-purple-400 blur-[106px] dark:from-blue-700"></div>
                <!-- <div class="h-32 bg-gradient from-cyan-400 to-sky-300 blur-[106px] dark:to-indigo-600"></div> -->
            </div>
            <div class="mx-auto px-4 pt-32 sm:px-12 sm:pt-40 md:pt-48 lg:pt-56 xl:max-w-6xl xl:px-0 ">
                <div class="relative z-10">
                    <div class="flex flex-col">
                        <h1 class="text-center text-5xl font-bold text-blue-900 dark:text-white sm:text-6xl md:text-left lg:text-7xl">
                            <span class="relative">
                                <svg class="absolute inset-x-0 -bottom-1 w-full opacity-50" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 260 15.6">
                                    <style>
                                        .st0 {
    fill: #957fef
                             ...
                             <center>
                             <span  class="relative text-blue-800 dark:text-white md:px-2 ">Gives A Visual Aid To Remember Your Business</span>
                             </center>   
                            </span>
                        </h1>
        ...
        <div class="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
            <div class="text-center">
                <!-- <h2 class="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl xl:text-5xl">Gives A Visual Aid To Remember Your Business</h2> -->
                ...
                <div role="tablist" aria-label="tabs" class="relative mx-auto mt-12 grid h-12 w-auto grid-cols-3 items-center gap-x-1 overflow-hidden rounded-full border border-gray-200 bg-gray-100 px-[3px] text-gray-600 dark:border-gray-700 dark:border-opacity-60 dark:bg-darker dark:text-gray-300 dark:shadow-none sm:w-max">
                    ...
                    <button role="tab" aria-selected="true" aria-controls="panel-0" tabindex="0" title="tab item" class="tab relative block rounded-full py-2.5 px-4 hover:text-primary dark:hover:text-primaryLight">
                ...
                <div class="gap-6 space-y-12 md:flex md:space-y-0">
                    <div class="relative md:w-1/2">
                        <div class="panel visible inset-0 flex scale-100 flex-col justify-center opacity-100 transition duration-500 md:absolute" id="panel-0">
                            <div>
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white md:text-3xl">Create a page to present who you are and what you do in one link.
                                ...
                                <div class="mt-12 space-y-6">
                                    <div class="flex items-center gap-6">
                                        <div class="flex h-20 w-20 rounded-3xl border border-gray-200 bg-white p-4 dark:border-gray-600/60 dark:bg-gray-900/40">
                                            <img class="m-auto h-8 w-auto" src="cdn-icons-png.flaticon.com/512/4727/4727266.png" alt="icon illustration" loading="lazy" width="512" height="512" />
                                        </div>
                                    ...
                                    <div class="flex items-center gap-6">
                                        <div class="flex h-20 w-20 rounded-3xl border border-gray-200 bg-white p-4 dark:border-gray-600/60 dark:bg-gray-900/40">
                                            <img class="m-auto h-8 w-auto" src="cdn-icons-png.flaticon.com/512/584/584796.png" alt="icon illustration" loading="lazy" width="512" height="512" />
                                        </div>
                                        <div class="w-[calc(100%-7.5rem)]">
                        ...
                        <div class="panel invisible absolute inset-0 flex scale-90 flex-col justify-center opacity-0 transition duration-500" id="panel-1">
                            <div>
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white md:text-3xl">Professional Take control and centralize your online presence.</h3>
                                <p class="mt-8 text-gray-600 dark:text-gray-300">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum omnis voluptatem accusantium nemo perspiciatis delectus atque autem! repellat expedita consequatur! Officiis id consequatur atque doloremque!</p>
                                <div class="mt-12 space-y-6">
                                    <div class="flex items-center gap-6">
                                        <div class="flex h-20 w-20 rounded-3xl border border-gray-200 bg-white p-4 dark:border-gray-600/60 dark:bg-gray-900/40">
                                            <img class="m-auto h-8 w-auto" src="cdn-icons-png.flaticon.com/512/6106/6106288.png" alt="icon illustration" loading="lazy" width="512" height="512" />
                                        </div>
                                        <div class="w-[calc(100%-7.5rem)]">
                                            <h4 class="text-lg font-semibold text-gray-800 dark:text-white">Together as one</h4>
                                            <p class="mt-1 text-gray-600 dark:text-gray-400">Accusantium nemo perspiciatis delectus atque autem!</p>
                                    ...
                                    <div class="flex items-center gap-6">
                                        <div class="flex h-20 w-20 rounded-3xl border border-gray-200 bg-white p-4 dark:border-gray-600/60 dark:bg-gray-900/40">
                                            <img class="m-auto h-8 w-auto" src="cdn-icons-png.flaticon.com/512/2313/2313906.png" alt="icon illustration" loading="lazy" width="512" height="512" />
                                        </div>
                                        <div class="w-[calc(100%-7.5rem)]">
                                            <h4 class="text-lg font-semibold text-gray-800 dark:text-white">New ideas</h4>
                                            <p class="mt-1 text-gray-600 dark:text-gray-400">Accusalectus atque autem accusantium nemo perspiciatis delectus atque autem!</p>
                        ...
                        <div class="panel invisible absolute inset-0 flex scale-90 flex-col justify-center opacity-0 transition duration-500" id="panel-2">
                            <div>
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white md:text-3xl">Easy for your audience to learn about you, simple for you to set up</h3>
                                <p class="mt-8 text-gray-600 dark:text-gray-300">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum omnis voluptatem accusantium nemo perspiciatis delectus atque autem! repellat expedita consequatur! Officiis id consequatur atque doloremque!</p>
                                <div class="mt-12 space-y-6">
                                    <div class="flex items-center gap-6">
                                        <div class="flex h-20 w-20 rounded-3xl border border-gray-200 bg-white p-4 dark:border-gray-600/60 dark:bg-gray-900/40">
                                            <img class="m-auto h-8 w-auto" src="cdn-icons-png.flaticon.com/512/3340/3340200.png" alt="icon illustration" loading="lazy" width="512" height="512" />
                                        </div>
                                        <div class="w-[calc(100%-7.5rem)]">
                                            <h4 class="text-lg font-semibold text-gray-800 dark:text-white">Together as one</h4>
                                            <p class="mt-1 text-gray-600 dark:text-gray-400">Accusantium nemo perspiciatis delectus atque autem!</p>
                                    ...
                                    <div class="flex items-center gap-6">
                                        <div class="flex h-20 w-20 rounded-3xl border border-gray-200 bg-white p-4 dark:border-gray-600/60 dark:bg-gray-900/40">
                                            <img class="m-auto h-8 w-auto" src="cdn-icons-png.flaticon.com/512/5405/5405929.png" alt="icon illustration" loading="lazy" width="512" height="512" />
                                        </div>
                                        <div class="w-[calc(100%-7.5rem)]">
        ...
        <div class="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
            <div class="space-y-6 md:flex lg:items-center lg:gap-6 lg:space-y-0">
                <div class="md:5/12 lg:w-6/12">
                    <img class="md:-ml-8" src="images/stats-login.webp" alt="tailus stats and login components" loading="lazy" width="1779" height="1592" />
                </div>
                <div class="md:7/12 lg:w-6/12">
                    <h2 class="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl xl:text-5xl">Stay up-to-date with the latest trends and news in your industry</h2>
                    <p class="mt-8 text-gray-600 dark:text-gray-300">Unlock your full potential and showcase your unique talents to the world with our user-friendly platform for creating stunning personal profiles</p>
                    <p class="mb-12 mt-4 text-gray-600 dark:text-gray-300">Whether you're looking for a new job, new clients, or new connections, your personal profile is the perfect tool to showcase your skills and expertise.</p>
                    <a href="pages/login.php" class="relative flex h-11 w-max items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition-transform before:duration-300 active:duration-75 active:before:scale-95 dark:before:bg-primaryLight">
    ...
    <section class="relative py-32">
        ...
        <div class="relative mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
            <div class="text-center">
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl xl:text-5xl">A technology-first approach</h2>
                <p class="mx-auto mt-6 text-gray-700 dark:text-gray-300 md:w-3/4 lg:w-3/5">Get started in just a few clicks and create a stunning personal profile that highlights your career achievements, educational background, and more.</p>
            </div>
            <div class="mt-16 grid gap-8 sm:mx-auto sm:w-2/3 md:w-full md:grid-cols-2 lg:grid-cols-3">
                <div class="rounded-3xl border border-gray-100 bg-white p-8 py-12 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none sm:p-12">
                    <div class="space-y-12 text-center">
                        <img src="cdn-icons-png.flaticon.com/512/584/584796.png" class="mx-auto h-14 w-auto" width="512" height="512" alt="burger illustration" />
                        <div class="space-y-6">
                            <h3 class="text-2xl font-semibold text-gray-800 transition dark:text-white">First feature</h3>
                            <p class="text-gray-600 dark:text-gray-300">Create your own personalized profile for free and showcase your skills, experience, and personality to the world.</p>
                ...
                <div class="rounded-3xl border border-gray-100 bg-white p-8 py-12 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none sm:p-12">
                    <div class="space-y-12 text-center">
                        <img src="cdn-icons-png.flaticon.com/512/6106/6106288.png" class="mx-auto h-14 w-auto" width="512" height="512" alt="burger illustration" />
                        <div class="space-y-6">
                            <h3 class="text-2xl font-semibold text-gray-800 transition dark:text-white">Second feature</h3>
                            <p class="text-gray-600 dark:text-gray-300">Easily create a professional-looking personal profile with our intuitive user interface and customizable features.!</p>
                            <a aria-label="read more" href="#" class="group relative mx-auto flex h-12 w-12 items-center justify-center before:absolute before:inset-0 before:rounded-full before:border before:border-gray-200 before:bg-gray-50 before:bg-gradient-to-b before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-gray-800">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="relative h-5 w-5 text-gray-600 transition duration-300 group-hover:translate-x-1 dark:text-white">
                                    <path fill-rule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clip-rule="evenodd" />
                                </svg>
                ...
                <div class="rounded-3xl border border-gray-100 bg-white p-8 py-12 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none sm:p-12">
                    <div class="space-y-12 text-center">
                        <img src="cdn-icons-png.flaticon.com/512/4727/4727266.png" class="mx-auto h-14 w-auto" width="512" height="512" alt="burger illustration" />
                        <div class="space-y-6">
                            <h3 class="text-2xl font-semibold text-gray-800 transition dark:text-white">Third feature</h3>
                            <p class="text-gray-600 dark:text-gray-300">Connect with like-minded individuals and expand your network by sharing your personal profile with friends, family, and colleagues.</p>
                            <a aria-label="read more" href="#" class="group relative mx-auto flex h-12 w-12 items-center justify-center before:absolute before:inset-0 before:rounded-full before:border before:border-gray-200 before:bg-gray-50 before:bg-gradient-to-b before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-gray-800">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="relative h-5 w-5 text-gray-600 transition duration-300 group-hover:translate-x-1 dark:text-white">
                                    <path fill-rule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clip-rule="evenodd" />
                                </svg>
        ...
        <!-- <div class="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
            ...
            <div class="mt-12 grid gap-8 md:grid-cols-2">
                <div class="rounded-3xl border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none sm:col-span-2 sm:px-12 lg:col-span-1 lg:row-span-2">
                    <div class="flex h-full flex-col justify-center space-y-6 md:space-y-8">
                        ...
                        <div class="flex items-center gap-3">
                            <img class="h-12 w-12 rounded-full" src="images/avatars/avatar-2.webp" loading="lazy" alt="user avatar" width="200" height="200" />
                            <div>
                ...
                <div class="space-y-6 rounded-3xl border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none">
                    <img class="h-12 w-auto" src="images/clients/airbnb.svg" loading="lazy" alt="airbnb" width="" height="" />
                    ...
                    <div class="flex items-center gap-3 text-left">
                        <img class="h-12 w-12 rounded-full" src="images/avatars/avatar-3.webp" alt="user avatar" width="200" height="200" loading="lazy" />
                        <div>
                ...
                <div class="space-y-6 rounded-3xl border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none">
                    ...
                    <p class="text-gray-600 dark:text-gray-300"><span class="font-serif">"</span>Sit amet consectetur adipisicing elit. Quaerat repellat perspiciatis excepturi est. Provident, omnis ut, sapiente veritatis cum deleniti repudiandae ad doloribus. <span class="font-serif">"</span></p>
                    <div class="flex items-center gap-3 text-left">
                        <img class="h-12 w-12 rounded-full" src="images/avatars/avatar-4.webp" alt="user avatar" width="200" height="200" loading="lazy" />
                        <div>
...
<svg width="92" height="96" viewBox="0 0 62 46" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M61.3282 2.64746C60.4378 0.990293 58.8478 0 57.0749 0H43.7903C41.9645 0 40.2658 1.06471 39.3569 2.77912L27.6968 24.8432L22.5292 15.0662C21.4957 13.1085 19.6327 11.9379 17.5472 11.9379C15.4642 11.9379 13.6013 13.1085 12.5651 15.0662L0.698316 37.5167C-0.239792 39.2912 -0.231842 41.4092 0.716866 43.1751C1.66557 44.9439 3.36159 46 5.25371 46H18.1302C19.9216 46 21.5858 44.9553 22.4736 43.2753L27.6968 33.3952L32.6178 42.7028C33.6911 44.7378 35.7051 46 37.8702 46H37.8993C39.9584 46 41.8717 44.7979 42.892 42.866L61.3441 7.95097C62.2239 6.28808 62.2186 4.30463 61.3282 2.64746ZM57.7692 6.16787L39.2933 41.1258C39.0468 41.5923 38.583 41.8871 38.0822 41.8871H37.5204C37.0169 41.8871 36.5478 41.5923 36.2987 41.1201L29.9572 29.1192L43.1702 4.11573H56.6668C57.1226 4.11573 57.5334 4.37046 57.7639 4.79978C57.9945 5.22623 57.9971 5.73855 57.7692 6.16787ZM25.4363 29.1192L18.6893 41.8843H5.56641C5.01255 41.8843 4.5117 41.5723 4.23345 41.0543C3.95254 40.5362 3.95254 39.9123 4.22815 39.3914L16.1003 16.9237C16.4024 16.357 16.943 16.0164 17.5472 16.0164C18.1514 16.0164 18.692 16.357 18.9941 16.9237L25.4363 29.1192Z" fill="#2B00D4"/>
</svg>
                ...
                <div class="relative">
                    <h2 class="mb-8 text-4xl font-bold text-blue-900 dark:text-white md:text-6xl">
                        Improve your
                        <span class="relative">
                            <svg class="absolute inset-x-0 -bottom-1 w-full opacity-50" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 260 15.6">
                                <path class="st0" d="M206.8 7.3l-.1.3c.1-.2.2-.3.1-.3zM234.7 10h-.1c-.2.4-.1.3.1 0zM54.8 4.2l-.6-.4c.2.4.4.5.6.4zM17.1 5.1zM34.5 9.6l.1.3c0-.2 0-.3-.1-.3zM22.4 10.8c-.3-.1-.7-.1-1-.1.2.1.7.1 1 .1zM17.5 5c-.1.1-.2.1-.4.2.2-.1.3-.2.4-.2zM52.7 9.8l.5.9c-.1-.3-.3-.6-.5-.9zM19.5 11.6c-.2-.2-.4-.2-.6-.3 0 .2.3.3.6.3zM120.9 11.4c-.1.1-.2.2-.2.3.3-.1.3-.2.2-.3zM80.9 10.4h-.1s.1.1.2.1l-.1-.1zM92.6 10.4l-.2.2c.2-.1.2-.1.2-.2zM72.1 11.3c-.1.1-.3.2-.4.3l.4-.3z" />
                            ...
                            <span class="relative px-2 text-blue-800 dark:text-indigo-200">workflow</span>
                        </span>
                    </h2>
                    <p class="mb-12 mt-6 text-gray-600 dark:text-gray-300 md:mx-auto md:w-5/6 lg:w-1/2">Saepe nulla ab nobis itaque corporis fuga illo doloribus sequi esse aspernatur impedit nihil quisquam, voluptates placeat architecto adipisci id cum enim.</p>
                    <a href="contact.html" class="relative mx-auto flex h-11 w-max items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition-transform before:duration-300 active:duration-75 active:before:scale-95 dark:before:bg-primaryLight">
                        <span class="relative text-base font-semibold text-white dark:text-gray-900">Get started</span>
                    </a>
                </div>
            </div>
                                ...
                                <div class="relative flex items-center rounded-full border border-primary/20 bg-white p-1 px-2 shadow-md dark:border-white/10 dark:bg-dark md:p-2 lg:pr-3">
                                    ...
                                    <div class="md:pr-1.5 lg:pr-0">
                                        <button type="button" title="Start buying" class="relative ml-auto h-12 w-16 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 active:duration-75 active:before:scale-95 dark:before:bg-primaryLight sm:w-auto sm:px-6">
                                            <span class="relative hidden w-max font-semibold text-white dark:text-gray-900 md:block"> Subscribe </span>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="relative mx-auto h-6 w-6 text-white dark:text-gray-900 md:hidden">
                                                <path d="M3.478 2.405a.75.75 0 00-.926.94l2.432 7.905H13.5a.75.75 0 010 1.5H4.984l-2.432 7.905a.75.75 0 00.926.94 60.519 60.519 0 0018.445-8.986.75.75 0 000-1.218A60.517 60.517 0 003.478 2.405z" />
                                            </svg>
                                        </button>
                ...
                <div class="grid grid-cols-8 gap-6 md:gap-0">
                    <div class="col-span-8 md:col-span-2 lg:col-span-3">
                        <div class="flex h-full items-center justify-between gap-6 border-b border-white py-6 dark:border-gray-800 md:flex-col md:items-start md:justify-between md:space-y-6 md:border-none md:py-0">
                            <div>
                                <a href="index-2.html" aria-label="neplen logo" class="flex items-center">
                                <svg class="h-7 w-auto" viewBox="0 0 189 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path class='dark:fill-white' d="M78.04 34V13H81.88L91.75 27.79V13H95.59V34H91.75L81.88 19.24V34H78.04ZM99.6611 34V13H113.371V16.09H103.501V21.85H112.471V24.85H103.501V30.91H113.371V34H99.6611ZM117.005 34V13H124.775C126.455 13 127.845 13.28 128.945 13.84C130.045 14.4 130.865 15.17 131.405 16.15C131.945 17.13 132.215 18.23 132.215 19.45C132.215 20.61 131.955 21.68 131.435 22.66C130.915 23.62 130.105 24.4 129.005 25C127.905 25.58 126.495 25.87 124.775 25.87H120.845V34H117.005ZM120.845 22.75H124.535C125.875 22.75 126.835 22.46 127.415 21.88C128.015 21.28 128.315 20.47 128.315 19.45C128.315 18.41 128.015 17.6 127.415 17.02C126.835 16.42 125.875 16.12 124.535 16.12H120.845V22.75ZM135.228 34V13H139.068V31H148.368V34H135.228ZM151.751 34V13H165.461V16.09H155.591V21.85H164.561V24.85H155.591V30.91H165.461V34H151.751ZM169.095 34V13H172.935L182.805 27.79V13H186.645V34H182.805L172.935 19.24V34H169.095Z" fill="black"  />
                                <path d="M61.3282 2.64746C60.4378 0.990293 58.8478 0 57.0749 0H43.7903C41.9645 0 40.2658 1.06471 39.3569 2.77912L27.6968 24.8432L22.5292 15.0662C21.4957 13.1085 19.6327 11.9379 17.5472 11.9379C15.4642 11.9379 13.6013 13.1085 12.5651 15.0662L0.698316 37.5167C-0.239792 39.2912 -0.231842 41.4092 0.716866 43.1751C1.66557 44.9439 3.36159 46 5.25371 46H18.1302C19.9216 46 21.5858 44.9553 22.4736 43.2753L27.6968 33.3952L32.6178 42.7028C33.6911 44.7378 35.7051 46 37.8702 46H37.8993C39.9584 46 41.8717 44.7979 42.892 42.866L61.3441 7.95097C62.2239 6.28808 62.2186 4.30463 61.3282 2.64746ZM57.7692 6.16787L39.2933 41.1258C39.0468 41.5923 38.583 41.8871 38.0822 41.8871H37.5204C37.0169 41.8871 36.5478 41.5923 36.2987 41.1201L29.9572 29.1192L43.1702 4.11573H56.6668C57.1226 4.11573 57.5334 4.37046 57.7639 4.79978C57.9945 5.22623 57.9971 5.73855 57.7692 6.16787ZM25.4363 29.1192L18.6893 41.8843H5.56641C5.01255 41.8843 4.5117 41.5723 4.23345 41.0543C3.95254 40.5362 3.95254 39.9123 4.22815 39.3914L16.1003 16.9237C16.4024 16.357 16.943 16.0164 17.5472 16.0164C18.1514 16.0164 18.692 16.357 18.9941 16.9237L25.4363 29.1192Z" fill="#2B00D4" />
                            </svg>
                                ...
                                <a href="https://tailus.io/" class="mt-2 inline-block text-sm">Designed by Neplen in UAE </a>
                            </div>

                            <div class="flex gap-6">
                                <a href="#" target="blank" aria-label="github" class="hover:text-primary dark:hover:text-primaryLight">
                                ...
                                <a href="#" target="blank" aria-label="twitter" class="hover:text-primary dark:hover:text-primaryLight">
                    ...
                    <div class="col-span-8 md:col-span-6 lg:col-span-5">
                        <div class="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:pl-16">
                            <div>
                                ...
                                <ul class="mt-4 list-inside space-y-4">
                                    <li>
                                        <a href="#" class="text-sm duration-100 hover:text-primary dark:hover:text-white">About</a>
                                    </li>
                                    <li>
                                        <a href="#" class="text-sm duration-100 hover:text-primary dark:hover:text-white">Customers</a>
                                    </li>
                                    <li>
                                        <a href="#" class="text-sm duration-100 hover:text-primary dark:hover:text-white">Enterprise</a>
                                    </li>
                                    <li>
                                        <a href="#" class="text-sm duration-100 hover:text-primary dark:hover:text-white">Partners</a>
                                    </li>
                                    <li>
                                        <a href="#" class="text-sm duration-100 hover:text-primary dark:hover:text-white">Jobs</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                        ...
                        <div class="flex justify-between text-sm md:pl-16">
                            <span>&copy; Neplen 2023 - Present</span>
